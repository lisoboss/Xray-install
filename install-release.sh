...
get_latest_version() {
  ...
  do
    ...
    grep -q "https://mirror.ghproxy.com/github.com/XTLS/Xray-core/releases/download/${releases_list[$i]}/Xray-linux-$MACHINE.zip" "$tmp_file" && break
  done
  "rm" "$tmp_file"
...
download_xray() {
  DOWNLOAD_LINK="https://mirror.ghproxy.com/github.com/XTLS/Xray-core/releases/download/${INSTALL_VERSION}/Xray-linux-${MACHINE}.zip"
...
install_geodata() {
  ...
  local download_link_geoip="https://mirror.ghproxy.com/github.com/v2fly/geoip/releases/latest/download/geoip.dat"
  local download_link_geosite="https://mirror.ghproxy.com/github.com/v2fly/domain-list-community/releases/latest/download/dlc.dat"
